<!-- ✅ الهيدر -->
<header class="bg-white shadow sm:px-[5%] border-b-2 border-orange-500">
    <div class="container mx-auto px-6 py-4 flex justify-between items-center">
        <a href="/" wire:navigate><h1 class="text-2xl font-bold text-orange-500">{{ config('app.name') }}</h1></a>
